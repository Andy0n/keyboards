...
keyboard.keymap = [
    [   # Layer: Default
        KC.GRAVE, KC.N1,    KC.N2,    KC.N3,    KC.N4,    KC.N5,        KC.N6,    KC.N7,    KC.N8,    KC.N9,    KC.N0,    KC.MINS,
    ...
    [   # Layer: 1 (Left)
        KC.ESC,   KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,      KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.RESET,
        KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,      KC.NLCK,  KC.P7,    KC.P8,    KC.P9,    KC.TRNS,  KC.TRNS,
        KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.EQL,   KC.TRNS,      KC.TRNS,  KC.P4,    KC.P5,    KC.P6,    KC.TRNS,  KC.TRNS,
    ...
    [   # Layer: 2 (Right)
        ...
        KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,      KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,  KC.TRNS,
                                      KC.TRNS,  KC.TRNS,  KC.DEL,       KC.TRNS,  KC.TRNS,  KC.TRNS,
