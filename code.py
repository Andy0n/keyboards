...
keyboard.keymap = [
    [
        ...
        KC.NUBS, KC.Z,  KC.X,  KC.C,    KC.V,    KC.B,        KC.N,     KC.M,   KC.COMM, KC.DOT, KC.SLSH, KC.QUOT,
                               KC.MO(1), KC.SPC, KC.LCTRL,    KC.RCTRL, KC.ENT, KC.MO(2),
                                        KC.RGUI, KC.BSPC,     KC.DEL,   KC.LALT    
    ],
    [
